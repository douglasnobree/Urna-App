...
def digitarCpf():
    global cpf
    cpf = input(f'Primeiramente, digite seu CPF (Sem formatação) para se identificar:')
    os.system('cls')
    print('Cpf computado com sucesso!')
    if len(cpf) != 11:
